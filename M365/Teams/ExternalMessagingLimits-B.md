...
- Deep dive (scope model, Exchange MOERA cap comparison, risk-acceptance playbook): `ExternalMessagingLimits-A.md`. One-shot exposure audit: `Scripts/Get-MOERAOnlyTenantExposure.ps1`. MC1463510 was published 28 Aug 2026 (archive: https://mc.merill.net/message/MC1463510); the promised admin throttling alert was still not documented as of 25 Sept 2026.
