...
- **Frontline vs. Enterprise/Business editions**: Windows 365 Frontline uses a shared-pool licensing model (fewer licenses than users, ratio-based) — a "no license available" error there means the shared pool is fully checked out, not that licensing is misconfigured. Reference: [Windows 365 Frontline](https://learn.microsoft.com/en-us/windows-365/enterprise/frontline-cloud-pcs)
